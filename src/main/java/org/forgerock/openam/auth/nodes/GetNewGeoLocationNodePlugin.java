 ...
 */
public class GetNewGeoLocationNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public GetNewGeoLocationNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
